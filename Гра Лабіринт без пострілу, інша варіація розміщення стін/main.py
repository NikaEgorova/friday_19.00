...
window_width = 700
window_height = 500
display.set_caption('labirint bober')
...
wall4 = GameSprite('wall.png', 200, 350, 25, 150)
...
player = Player('player.png', 5, window_height -80, 60, 60, 0, 0)
monster = Enemy('monster.png', 450, 200, 80, 80, 3)
monstr = Enemy1('monster.png', 50, 170, 80, 80, 3)
monstryk = GameSprite('monster.png', 250, 280, 80, 80)
finish = GameSprite('diod.png', 550, window_height -80, 80, 80)
...
while run:
    ...
    if not win:
        ...
        if sprite.collide_rect(player, monster) or sprite.collide_rect(player, monstr) or sprite.collide_rect(player, monstryk):
            win = True
